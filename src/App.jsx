...
【記述ルール】
1. だ・である調で統一する。受動態は使わない（例：「提示された」→「〇〇が提示した」、「確認された」→「〇〇が確認した」、「決定された」→「〇〇が決定した」）。主語（誰が）を明確にした能動表現で記載する。口語表現・話し言葉（「〜してもらう」「〜していく」「〜なんですが」等）も避け、文語・書き言葉で記載する
